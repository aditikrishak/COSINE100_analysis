# modulation period fixed at 365.25 days, w = 0.0172 rad/day
...
#combined chi^2 value of background fit
def chi2_bg(P):
...
#log likelihood value of background fit
...
#chi^2 value of bg+modulation fit
def chi2_cosine(P):
    A = P[15]
    t_0=P[16]
...
#log likelihood value of bg+modulation fit
...
def plot(bg_fit, cosine_fit):
    ...
    plt.savefig("analysis_02_fig.png")
    
#============================================================================

#best fit for bg+modulation model by chi^2 minimzation
